...
sys.path.append('Licence_plate_recognition_model/ultralytics')
...
def parse_opt():
    ...
    parser.add_argument('--weight', type=str, default='best.pt', help='training model path')
    parser.add_argument('--source', type=str, default='D:/lg/BaiduSyncdisk/project/person_code/project_self/chepai_OCR\data/traindata\yolo/test/images/test/01-90_85-274&482_457&544-456&545_270&533_261&470_447&482-0_0_16_24_31_28_31-146-27.jpg', help='source directory for images or videos')
